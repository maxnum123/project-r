...
#------------COUNT-----------------------
trace = go.Bar(x = (len(M), len(B)), y = ['M=Malignant', 'B=Benign'], orientation = 'h', opacity = 0.8, marker=dict(
...
#------------PERCENTAGE-------------------
trace = go.Pie(labels = ['B=Benign','M=Malignant'], values = data['diagnosis'].value_counts(), 
